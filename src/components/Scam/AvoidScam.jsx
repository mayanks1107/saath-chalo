...
function AvoidScam(props) {
  return (
    ...
    <div div className="con2-title">
      <h3 className='scam-txt'>What you can do to avoid a scam</h3>
    </div>
    <div class="con3">
      <div class="box">
        
          <img className='ser-img ' src={props.block} alt="block" />
          <h3 className='scam-txt'>Never visit links sent by drivers</h3>
      ...
      <div class="box">
          ...
          <h3 className='scam-txt'>For cash-only rides, always pay in the car</h3>
      ...
      <div class="box">
        ...
        <h3 className='scam-txt'>Only pay the service fee on our app.</h3>
